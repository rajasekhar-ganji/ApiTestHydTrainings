...
public class JWTBearerDeleteWiremock {
   ...
   Response response= RestAssured.given().baseUri(Constant.baseurl).header(Constant.authorization,Constant.bearer + Constant.JwtBearerToken).accept(ContentType.JSON).when().delete(Constant.delete).then()
