...
public class Constant {
	    ...
	    public final static String petpost = PROJECT_BASE_PATH + "/src/test/resources/petadd.json";
	    public final static String updatepet = PROJECT_BASE_PATH + "/src/test/resources/updatepet.json";
	    public final static String uploadpic = PROJECT_BASE_PATH + "/src/test/resources/puppy.jpg";
	    ...
	    public final static String propertyfile_path1  = PROJECT_BASE_PATH + "/src/test/resources/PetSwaggerProperties.properties";
	    //base url
	    public final static String baseurl="http://localhost:8080";
	    //end points
	    public final static String get="/api/employees";
	    public final static String post="/api/employees/create";
	    public final static String put="/api/employees/modify";
	    public final static String patch="/api/employees/partialmodify";
	    public final static String delete="/api/employees/9";
	    ...
	    public final static String matchValue="data.employee_name";
	    public final static String matchsalaryValue="data.employee_salary";
