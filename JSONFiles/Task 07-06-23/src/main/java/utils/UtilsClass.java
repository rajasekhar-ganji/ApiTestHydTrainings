...
public class UtilsClass {
	...
	public static void Xlcovertjson(String request) throws Exception {
		String jsonData=XldataUtils.convertSheetToJson(request);
		String filePath=null;
			if(request.equals("post")) {
		    filePath =ConstantPathsAndvalues.addpet;
			  }
			  else if(request.equals("put"))
			  {
				  filePath =ConstantPathsAndvalues.updatepetdata;
			  }
	...
	public static void addPetToStoreNow() {
		...
		passingdata = HelperUtils.ConnectJsonFile(HelperUtils.ConnectPropertyFile("requestname1"));
	...
	public static void updatePetData() {
		log.info("Before get response");
		passingdata = HelperUtils.ConnectJsonFile(HelperUtils.ConnectPropertyFile("requestname2"));
